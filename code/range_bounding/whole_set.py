...
def get_z(
    ...
    return [
        ...
        Le(vxMin, x4 * (1 - x2 * Curvature)),
        Le(x4 * (1 + x2 * Curvature), vxMax),
        Le(dpsiMin, Curvature * x4),
        Le(Curvature * x4, dpsiMax),
        ...
        Le(ayMin, u2 + Curvature * x4 ** 2 * (1 - x2 * Curvature)),
        Le(u2 + Curvature * x4 ** 2 * (1 - x2 * Curvature), ayMax)
    ], [x1, x2, x3, x4, u1, u2]
